        ...
        <div style="width: 100%">
            ...
            <div style="height: 30px;">
                <div class="navbar-nav me-auto mb-2 mb-lg-0 container-fluid d-flex justify-content-md-center"
                    ...
                    <li class="nav-item me-5 mb-2 mb-lg-0" style="width:  auto;">
                        <a class="nav-link" href="/administrador/postulacion">
                            <h5>Lista De Postulaciones</h5>
                        </a>
                    </li>

                    <li class="nav-item me-5 mb-2 mb-lg-0" style="width:  auto;">
                        <a class="nav-link" href="/administrador/servicios">
                            <h5>Lista De Servicios</h5>
                        </a>
                    </li>

                    <li class="nav-item me-5 mb-2 mb-lg-0" style="width:  auto;">
                        <a class="nav-link" href="/administrador/pqr">
                            <h5>Lista De PQR</h5>
                        </a>
                    </li>

                    <li class="nav-item me-5 mb-2 mb-lg-0" style="width:  auto;">
                        <a class="nav-link" href="/administrador/reportes">
